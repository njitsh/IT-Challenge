  ...
  <?php if (isset($_SESSION['u_id']))
  {
    if ($_SESSION['u_id'] == "1")
    {
      ...
      $sql = "SELECT * FROM tbl_orders";
          ...
          <form class="order" action="includes/create_order.inc.php" method="POST">
              ...
              <input type="materiaal" name="materiaal" placeholder="Voer hier het labelmateriaal in" required title="Voer het materiaal in">
              ...
              <input type="afwerking" name="afwerking" placeholder="Voer hier de afwerkingsmethode in" required title="Voer hier de afwerkingsmethode in">
