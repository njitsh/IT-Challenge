...
$msg .= '<head> <link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title>Pentolabel Order confirmation</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>';
...
$msg .= 'Hartelijk dank voor je bestelling bij Pentolabel. Je order is bij ons bekend onder ordernummer: <strong>'.$_SESSION['o_id'].'</strong>';
$msg .= '<h4><strong>Overzicht van je bestelling</strong></h4>';
$msg .= 'Datum van je bestelling: '.date('d-m-Y', $datum_aangemaakt).'<br><br>';
...
$msg .= '</table>';
$msg .= '<a style="text-decoration: none;" href="http://localhost:8080/IT-Challenge/public/order?order='.$_SESSION['o_id'].'"><table style="padding: 10px; width: 100%; background-color: #dc5626; color: white;" border="0"><tr><td align="center">Mijn order bekijken</td></tr></table></a>';
...
$headers .= 'From: Pentolabel <stijn@sharks.nl>' . "\r\n";
