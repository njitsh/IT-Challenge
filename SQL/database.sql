...
CREATE TABLE tbl_orders(
    ...
    breedte float(11) NOT NULL,
    hoogte float(11) NOT NULL,
    radius float(11) NOT NULL,
    tussenafstand float(11) NOT NULL,
    rolbreedte float(11) NOT NULL,
    ...
    prijs1 float(11) NULL,
    prijs2 float(11) NULL,
    datum_aangemaakt datetime NOT NULL,
    datum_laatst_bewerkt datetime NOT NULL,
    status varchar(256) DEFAULT 'Aanvraag' NOT NULL,
